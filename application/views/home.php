...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>Career Planning Access</title>

    <link href="../fonts.googleapis.com/css9b11.css?family=Poppins:400,300,500,600,700" rel="stylesheet">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div data-aos="fade-up" data-aos-delay="700" class="col-md-6 banner-right text-center">
                    <img class="img-fluid" src="assets/img/banner1.png" alt="Gambar Banner">
                </div>
            </div>
        </div>
        <div class="wave">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 col-md-12 about-left">           
                <img data-aos="fade-right" data-aos-delay="200" class="img-fluid" src="assets/img/banner2.png" alt="Gambar Banner">
            </div>
            <div class="col-lg-5 col-md-7 about-right">
                <h1 data-aos="fade-left" data-aos-delay="200">Perencanaan Karir</h1>
                <p data-aos="fade-left" data-aos-delay="400">Perencanaan karir merupakan hal penting yang harus dimiliki setiap individu ketika memasuki dunia karir sesungguhnya. Kemampuan seseorang dalam membuat perencanaan karir secara matang maka akan berdampak pada kemampuan pilihan karir ke depannya.
                </p>
                <p data-aos="fade-left" data-aos-delay="400">
                    Gambaran tentang perencanaan karir terintegrasi pada kesuksesan karir yang identik dengan kesejahteraan. Maka dibutuhkan pengetahuan dan perencanaan karir yang tepat di masa depan agar dapat meraih impian siswa.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 footer-left">
                ...
                <p class="copyright-text">&copy; 2020 Made By
                    <a href="" target="_blank">Haris Yuftika Hani</a>
                </p>
            </div>
            <div class="col-lg-7">
