    ...
    <div class="header-body">
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-xs-12">
          <form role="form" action="<?= site_url('siswa/test/tambah_post2') ?>" method="POST" style="text-align: justify;">
              ...
              <div class="card-body">
               <div class="col">
                ...
                <div class="text-center">
                  <div class="progress">
                    <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 50%;"></div>
                  </div>
                </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="kategori" value="post-kat2">
