    ...
    <div class="header-body">
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-xs-12">
          <form role="form" action="<?= site_url('siswa/test/tambah_post4') ?>" method="POST" style="text-align: justify;">
            <div class="card card-stats mb-4 mb-xl-0">
              <div class="card-body">
               <div class="col">
                <h1 class="card-title text-uppercase text-blue mb-0" style="text-align: center;"><b>POST TEST</b></h1><br/>

                <div class="text-center">
                  <div class="progress">
                    <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                  </div>
                </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="kategori" value="post-kat4">
