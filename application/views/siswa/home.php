  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 banner-left">
        <h1 data-aos="fade-down" class="display-3 text-white">Selamat Datang</h1>
        ...
        <p data-aos="fade-down" data-aos-delay="300" class="text-white mt-0 mb-4">
          Di Aplikasi <b><b>Career Planning Access</b></b>
        </p>
      ...
      <div data-aos="fade-up" data-aos-delay="700" class="col-md-6 banner-right text-center">
        <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/banner1.png" alt="Gambar Banner">
      </div>
    </div>
  </div>
