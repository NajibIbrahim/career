    ...
    <div class="header-body">
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-xs-12">
          <form role="form" action="<?= site_url('siswa/test/tambah_pre4') ?>" method="POST" style="text-align: justify;">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id_kategori" value="pre-kat4">
            ...
            <!-- batas soal -->
            <button class="col-md-2 btn btn-primary pull-right" type="submit" name="simpan">Simpan</button>
