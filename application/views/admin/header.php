...
<head>
  ...
  <title>
    Career Planning Access
  </title>
  <!-- Favicon -->
  <link href="<?php echo base_url(); ?>assets/img/icon.png" rel="icon" type="image/png">
  <!-- Fonts -->
  ...
  <link href="<?php echo base_url(); ?>assets/login/js/plugins/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" />
  <!-- CSS Files -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="">
        <img src="<?php echo base_url(); ?>assets/login/img/logo.png" class="navbar-brand-img" alt="assets.">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url(); ?>admin/pengisi">
              <i class="ni ni-single-copy-04 text-blue"></i> Data Pengisi
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url(); ?>admin/materi">
              <i class="ni ni-book-bookmark text-blue"></i> Data Materi
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url(); ?>admin/akun">
              <i class="ni ni-single-02 text-blue"></i> Data Akun
            </a>
          </li>
        </ul>
