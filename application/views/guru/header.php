    ...
    <div class="container-fluid">
      ...
      <ul class="nav align-items-center d-md-none">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            <a href="<?php echo base_url() ?>guru/dashboard/logout" class="dropdown-item">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url(); ?>guru/materi">
          ...
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url(); ?>guru/ubahpassword">
