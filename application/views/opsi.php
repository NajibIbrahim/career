    ...
    <div class="header py-7 py-lg-8">
      <div class="container">
        <div class="header-body text-center mb-5">
          <h1 class="text-center text-white">Login Sebagai</h1>
        </div>
      </div>
    </div>
    <!-- Page content -->
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-muted mb-4">
                <a class="navbar-brand" href="<?php echo base_url(); ?>login">
                  <img src="<?php echo base_url(); ?>assets/login/img/siswa.png" height="30px" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-4 pb-2">
          <div class="card bg-secondary border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-muted mb-4">
                <a class="navbar-brand" href="<?php echo base_url(); ?>login">
                  <img src="<?php echo base_url(); ?>assets/login/img/guru.png" height="30px" />
                </a>
              </div>
        ...
        <div class="col-lg-4 col-md-4 pb-2">
          <div class="card bg-secondary border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-muted mb-4">
                <a class="navbar-brand" href="<?php echo base_url(); ?>login">
                  <img src="<?php echo base_url(); ?>assets/login/img/admin.png" height="30px"   />
                </a>
              </div>
